"""
Django settings for CSH project.LIVE
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Mysql_7319',  # Replace with your database password Mysql_MH-047319
        # 'HOST': '13.126.65.190',       # IP FOR TEST
        'HOST': '172.16.20.48',       # IP FOR LOCAL VM
        'PORT': '3306',            
        'OPTIONS': {
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'D:/Python Project/Documents/') #local
# MEDIA_ROOT = os.path.join(BASE_DIR, '/home/ubuntu/Documents/') #test
